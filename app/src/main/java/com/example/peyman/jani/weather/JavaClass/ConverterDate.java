...
public class ConverterDate {
    ...
    public static void getCurrentShamsidate(String weekday,String datem) {

        Date date = new Date(""+weekday+","+datem+"");
        Locale loc = new Locale("en_US");
        ConverterDate util = new ConverterDate();

        SolarCalendar sc = util.new SolarCalendar(date);
        GetDate.WeekDay=sc.strWeekDay;
        GetDate.Day=sc.date;
        GetDate.MonthStr=sc.strMonth;
        GetDate.Year=sc.year;
